		  ...
		  <tr>
		    <td>
		    	<div align="left" class="STYLE21">
					流程名称：<s:textfield name="filename" cssStyle="width: 200px;"/><br/><br/>
					流程文件:<s:file name="file" cssStyle="width: 200px;"/><br/><br/>
					<input type="submit" value="上传流程" class="button_ok" style= "height:30px;"/>
				</div>
		    </td>
		  </tr>
	</table>
